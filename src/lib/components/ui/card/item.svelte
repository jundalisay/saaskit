...
<div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-card cursor-pointer" on:click>
  ...
  <div class="p-4">
    ...
    <p class="text-lg font-semibold mb-4">{item.price} Points</p>
    <!-- toFixed(2) -->
...
<div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
  <img class="w-full h-48 object-cover" src={item.imageUrl} alt={item.name} />
  <div class="p-4">
    <h2 class="font-bold text-xl mb-2">{item.name}</h2>
    <p class="text-gray-700 text-base mb-4">{item.description}</p>
    ...
    <div class="flex items-center mb-4">
      <input
        ...
        min="1"
        bind:value={quantity}
        class="border rounded p-2 mr-2 w-16"
      />
      <button
...
<!-- <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
  <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
    <img class="object-cover" src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="item image" />
