<script lang="ts">
  ...
  console.log('Page Svelte Profiles Users Index: ', data.profiles);
...
<!-- bind:value={sortOption} bind:value={sortOption} on:change={handleSortChange}-->
<div class="px-4">
    ...
    <form>
        <div class="flex">
          ...
          <div class="relative w-full">
            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search for Exchangers" required />
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    {#if data.profiles}
      {#each data.profiles as profile}
        ...
        <div on:click={()=> go(profile.id)} class="cursor-pointer" >
          <ProfileCard {profile}  />
        </div>
